...
export default function (data) {
  ...
  const response = http.post(
    ...
    null,
    {
      ...
      tags: { name: `deposit_${action}_concurrent_request` },
    },
  );
  ...
  check(response, {
    'deposit decision accepted or rejected as already processed': () => isAccepted || isAlreadyProcessedRejected,
  });
}
